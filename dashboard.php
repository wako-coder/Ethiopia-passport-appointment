...
<body>
  ...
  <!-- ======= Header ======= -->
  <header style="" id="header" class="fixed-top ">
    ...
    <div class="container d-flex align-items-left">
      ...
      <nav class="nav-menu d-none d-lg-block align-items-right">
        <ul> 
          <li class="active"><a style=" color: yellow;" href="index.html">Home</a></li>
          <li><a style="" href="form.html">schedule Appointment</a></li>            
